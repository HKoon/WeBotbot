...
if __name__ == '__main__':
    data = {'permissionUserName': ['Idea京儿', '观景之'], 'KEY': ['changed']}
    i = get_dataDict('E:\\AGithub\\WeBotbot-master\\setting.xlsx',0,u'setting')
    print(i)
    update_dataDict('E:\\AGithub\\WeBotbot-master\\setting.xlsx',data)
    i = get_dataDict('E:\\AGithub\\WeBotbot-master\\setting.xlsx',0,u'setting')
    print(i)
